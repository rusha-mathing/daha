...
from app.core.models import (
    SubjectResponse, DifficultyResponse, OrganizationResponse, GradeResponse, 
    CourseResponse, CreateResponse, SubjectCreate, DifficultyCreate, 
    OrganizationCreate, GradeCreate, CourseCreate, PaginationParams, 
    PaginatedResponse, CourseFilters
)
from app.core.services import (
    subject_service, difficulty_service, organization_service, 
    grade_service, course_service
)
from app.core.exceptions import NotFoundError, DatabaseError, ValidationError
from app.models import get_session, Course, Subject, Difficulty, Organization, Grade

improved_router = APIRouter()


# Subject endpoints
@improved_router.get('/subjects/', response_model=List[SubjectResponse])
async def get_subjects(session: AsyncSession = Depends(get_session)):
    """Get all subjects"""
    return await subject_service.get_all(session)


@improved_router.get('/subjects/{id}', response_model=SubjectResponse)
async def get_subject(id: int, session: AsyncSession = Depends(get_session)):
    """Get a subject by ID"""
    return await subject_service.get_by_id(session, id)


@improved_router.post('/subjects/', response_model=CreateResponse, status_code=status.HTTP_201_CREATED)
...
@improved_router.put('/subjects/{id}', response_model=SubjectResponse)
...
@improved_router.delete('/subjects/{id}', status_code=status.HTTP_204_NO_CONTENT)
...
@improved_router.get('/difficulties/', response_model=List[DifficultyResponse])
async def get_difficulties(session: AsyncSession = Depends(get_session)):
    """Get all difficulties"""
    return await difficulty_service.get_all(session)


@improved_router.get('/difficulties/{id}', response_model=DifficultyResponse)
...
@improved_router.post('/difficulties/', response_model=CreateResponse, status_code=status.HTTP_201_CREATED)
...
@improved_router.put('/difficulties/{id}', response_model=DifficultyResponse)
...
@improved_router.delete('/difficulties/{id}', status_code=status.HTTP_204_NO_CONTENT)
...
@improved_router.get('/organizations/', response_model=List[OrganizationResponse])
...
@improved_router.get('/organizations/{id}', response_model=OrganizationResponse)
...
@improved_router.post('/organizations/', response_model=CreateResponse, status_code=status.HTTP_201_CREATED)
...
@improved_router.put('/organizations/{id}', response_model=OrganizationResponse)
...
@improved_router.delete('/organizations/{id}', status_code=status.HTTP_204_NO_CONTENT)
...
@improved_router.put('/grades/{id}', response_model=GradeResponse)
...
@improved_router.delete('/grades/{id}', status_code=status.HTTP_204_NO_CONTENT)
async def delete_grade(id: int, session: AsyncSession = Depends(get_session)):
    """Delete a grade"""
    await grade_service.delete(session, id)


# Course endpoints with pagination and filtering
@improved_router.get('/courses/', response_model=PaginatedResponse[CourseResponse])
...
@improved_router.get('/courses/{id}', response_model=CourseResponse)
...
@improved_router.post('/courses/', response_model=CourseResponse, status_code=status.HTTP_201_CREATED)
...
@improved_router.delete('/courses/{id}', status_code=status.HTTP_204_NO_CONTENT)
