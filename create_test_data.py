...
<g>
	...
	<path style="fill:#333333;" d="M352.557,400.225H232.321c-5.45,0-9.867,4.418-9.867,9.867s4.416,9.867,9.867,9.867h120.237
        ...
        define_organization('Сириус')
        define_organization('Иннополис')
        define_organization('Сколтех')
        define_organization('VK')
        define_organization('СберКибер')
        define_organization('Лаборатория Касперского')
        define_organization('Высшая школа экономики')
        define_organization('Сколково')
        define_organization('Центральный банк РФ')
        define_organization('Тинькофф')
        define_organization('МФТИ')
        define_organization('МГУ им. Ломоносова')
        define_organization('Летово')
        define_organization('Сбер')
